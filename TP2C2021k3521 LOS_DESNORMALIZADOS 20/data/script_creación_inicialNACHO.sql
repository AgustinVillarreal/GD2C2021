...
ALTER TABLE los_desnormalizados.Viaje_x_paquete 
ADD
...
ALTER TABLE los_desnormalizados.Recorrido
ADD
	FOREIGN KEY (ciudad_destino_id) REFERENCES los_desnormalizados.Ciudad (ciudad_id),
	FOREIGN KEY (ciudad_destino_id) REFERENCES los_desnormalizados.Ciudad (ciudad_id)
GO

ALTER TABLE los_desnormalizados.Taller
ADD	FOREIGN KEY (ciudad_id) REFERENCES los_desnormalizados.Ciudad (ciudad_id)
GO

ALTER TABLE los_desnormalizados.Modelo
ADD	FOREIGN KEY (marca_id) REFERENCES los_desnormalizados.Marca (marca_id)


ALTER TABLE  los_desnormalizados.Tarea 
ADD	FOREIGN KEY (tipo_tarea_id) REFERENCES los_desnormalizados.Tipo_tarea (tipo_tarea_id)
GO

ALTER TABLE los_desnormalizados.Camion
ADD	FOREIGN KEY (modelo_id) REFERENCES los_desnormalizados.Modelo (modelo_id)
GO


ALTER TABLE los_desnormalizados.Paquete 
ADD
	FOREIGN KEY (tipo_paquete_id) REFERENCES los_desnormalizados.Tipo_paquete(tipo_paquete_id)
GO


ALTER TABLE los_desnormalizados.Orden_trabajo 
ADD
...
ALTER TABLE los_desnormalizados.Mecanico 
ADD
	FOREIGN KEY (taller_id) REFERENCES los_desnormalizados.Taller (taller_id)
GO

ALTER TABLE los_desnormalizados.Tarea_x_orden
ADD
...
ALTER TABLE  los_desnormalizados.Material_x_tarea
ADD
